...
export default function HistorialConsultas() {
    ...
    return (
        <div className="container-fluid p-0 bg-light" style={{ height: "100vh", overflowY: "auto" }}>
            ...
            <div className="bg-white text-dark p-3 shadow-sm border-bottom d-flex justify-content-between align-items-center sticky-top" style={{ zIndex: 1050 }}>
                <div className="d-flex align-items-center">
                    ...
                    <div>
                        <h4 className="m-0 fw-bold text-dark">Historia Clínica</h4>
                        <small className="text-secondary">Nueva Consulta - {pacienteActual?.nombres} {pacienteActual?.apellidos}</small>
                    </div>
                </div>
                <div className="d-flex gap-3">
                    <button className="btn btn-outline-dark px-4 fw-bold border-2" onClick={() => navigate(-1)}>
