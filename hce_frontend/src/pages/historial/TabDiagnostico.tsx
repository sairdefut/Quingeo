    ...
    <div className="row g-4 w-100 m-0">
      ...
      <div className="col-md-6 border-end">
        ...
        <ExpandableTextarea
          ...
          value={estudios}
          onChange={(e: any) => setEstudios(e.target.value)}
      ...
      <div className="col-md-6">
        ...
        <ExpandableTextarea
          ...
          onChange={(e: any) => setPlanFarmacologico({ ...planFarmacologico, esquema: e.target.value })}
          placeholder="Medicación detallada: Fármaco, Dosis, Frecuencia, Duración..."
          baseHeight="62px"
        />

        <div className="row g-2 mb-3">
          {/* Se eliminó Vía Venosa. Vía oral ahora ocupa todo el ancho disponible (col-12) */}
          <div className="col-12">
        ...
        <ExpandableTextarea
          ...
          onChange={(e: any) => setPlanNoFarmacologico({ ...planNoFarmacologico, otros: e.target.value })}
          baseHeight="62px"
        />
      </div>
