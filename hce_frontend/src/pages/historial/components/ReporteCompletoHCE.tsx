...
export const ReporteCompletoHCE = forwardRef<HTMLDivElement, { paciente: any }>(({ paciente }, externalRef) => {
    ...
    return (
        <div className="container-fluid bg-light p-4 reporte-hce-page" id="reporte-hce">
            <div className="d-flex justify-content-between align-items-center mb-3 d-print-none gap-2 flex-wrap">
                <div>
                ...
                <div className="d-flex gap-2">
                    <button className="btn btn-outline-primary" onClick={() => navigate(-1)}>
                        <i className="bi bi-arrow-left me-2"></i>Regresar a Gestion
                    </button>
            ...
            <div ref={externalRef}>
                ...
                {consultas.length === 0 ? (
                    ...
                    <div className="mt-4">
                                ...
                                <article className="consulta-card" key={consulta.idConsulta || consulta.id || index}>
                                    ...
                                    <Bloque titulo="Examen fisico y signos vitales">
                                        <div className="row g-2">
                                            ...
                                            <div className="col-md-3"><strong>FC:</strong> {valor(vitales.fc ?? vitales.frecuenciaCardiaca, '-')} lpm</div>
                                            <div className="col-md-3"><strong>FR:</strong> {valor(vitales.fr ?? vitales.frecuenciaRespiratoria, '-')} rpm</div>
                                            <div className="col-md-3"><strong>SpO2:</strong> {valor(vitales.spo2 ?? vitales.saturacionOxigeno, '-')}%</div>
                                            <div className="col-md-3"><strong>Perimetro cefalico:</strong> {valor(vitales.perimetroCefalico, '-')}</div>
                                            <div className="col-md-3"><strong>Aspecto general:</strong> {valor(vitales.aspectoGeneral, '-')}</div>
                                            <div className="col-md-3"><strong>Glasgow:</strong> {valor(vitales.glasgow, '-')}</div>
                                            <div className="col-12"><strong>Evolucion:</strong> {valor(consulta.examenFisico?.evolucion || consulta.evolucionClinica)}</div>
                                    ...
                                    <Bloque titulo="Diagnostico, estudios y plan">
                                        <div className="row g-2">
                                            ...
                                            <div className="col-md-6"><strong>Via oral:</strong> {valor(plan.farmacologico?.viaOral, '-')}</div>
                                            <div className="col-md-6"><strong>Via venosa:</strong> {valor(plan.farmacologico?.viaVenosa, '-')}</div>
                        ...
                        <div className="mt-5 pt-4 row text-center small firmas-reporte" style={{ pageBreakInside: 'avoid' }}>
                            <div className="col-6">
                                <div style={{ borderTop: '1px solid black', width: '85%', margin: '0 auto', paddingTop: '8px' }}>
                                    <strong>Firma del Medico Tratante</strong><br />
                                    <span className="text-muted small">Sello y Codigo Profesional</span>
                                </div>
                            </div>
                            <div className="col-6">
                                <div style={{ borderTop: '1px solid black', width: '85%', margin: '0 auto', paddingTop: '8px' }}>
...
ReporteCompletoHCE.displayName = 'ReporteCompletoHCE';
