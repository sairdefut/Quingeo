        ...
        <div className="tab-content border rounded p-4 bg-white shadow-sm mb-5">
            ...
            {tabActiva === 'diagnostico' && (
                <TabDiagnostico
                    ...
                    referenciaHospital={diagnostico.referenciaHospital} setReferenciaHospital={diagnostico.setReferenciaHospital}
                    motivoReferencia={diagnostico.motivoReferencia} setMotivoReferencia={diagnostico.setMotivoReferencia}
