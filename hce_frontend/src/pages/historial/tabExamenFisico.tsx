...
const ExpandableTextarea = ({ value, onChange, placeholder, disabled, className = "form-control" }: any) => {
  ...
  React.useEffect(() => {
    ...
    if (isFocused) {
      ...
      // Le ponemos 86px de base para que simule los rows={3} originales de esta vista
      el.style.setProperty('height', '86px', 'important');
    }
  }, [value, isFocused]);
    ...
    <div className="row g-3 w-100 m-0">
      ...
      <div className="col-12 mt-3">
        ...
        <ExpandableTextarea
          ...
          value={evolucionClinica}
          onChange={(e: any) => setEvolucionClinica(e.target.value)}
